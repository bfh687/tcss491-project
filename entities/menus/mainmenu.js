class MainMenu {
  constructor(game, x, y) {
    ...
    this.spritesheet = ASSET_MANAGER.getAsset(sprites.homescreen);

    this.wKey = ASSET_MANAGER.getAsset(sprites.w_key);
    this.aKey = ASSET_MANAGER.getAsset(sprites.a_key);
    this.sKey = ASSET_MANAGER.getAsset(sprites.s_key);
    this.dKey = ASSET_MANAGER.getAsset(sprites.d_key);
    this.eKey = ASSET_MANAGER.getAsset(sprites.e_key);
    this.tabKey = ASSET_MANAGER.getAsset(sprites.tab_key);
    this.spaceKey = ASSET_MANAGER.getAsset(sprites.space_key);
    this.back = ASSET_MANAGER.getAsset(sprites.back_button);
  ...
  updateCredits() {
    if (this.game.keys[" "]) this.creditsOffset -= this.game.clockTick * 200;
    else this.creditsOffset -= this.game.clockTick * 75;
  }
