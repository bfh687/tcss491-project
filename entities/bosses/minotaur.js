class Minotaur {
  constructor(game, x, y) {
    ...
    this.spritesheet = ASSET_MANAGER.getAsset(sprites.minotaur);
    this.animations = [];
    this.loadAnimations();
  ...
  update() {
    ...
    if (this.spellState && this.spellStateDuration >= 0) {
      ...
      if (this.spellCooldown <= 0) {
        ...
        setTimeout(() => {
          if (this.fxcount == 0) ASSET_MANAGER.playAudio(sfx.thunderfx0);
          else if (this.fxcount == 1) ASSET_MANAGER.playAudio(sfx.thunderfx1);
          else if (this.fxcount == 2) ASSET_MANAGER.playAudio(sfx.thunderfx2);
          else if (this.fxcount == 3) ASSET_MANAGER.playAudio(sfx.thunderfx3);
...
class LightningSpell {
  constructor(game, x, y) {
    ...
    // load spritesheet
    this.spritesheet = ASSET_MANAGER.getAsset(sprites.thunder_spell);
