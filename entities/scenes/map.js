...
class Map2 {
  constructor(game, x, y) {
    Object.assign(this, { game, x, y });
    this.spritesheet = ASSET_MANAGER.getAsset("./sprites/map/alt_hub.png");
    this.bounding_boxes = [];
  }
  ...
  draw(ctx) {
    ctx.drawImage(this.spritesheet, 0, 0, 608, 448, this.x - this.game.camera.x, this.y - this.game.camera.y, 608 * 2, 448 * 2);
