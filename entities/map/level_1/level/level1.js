...
const level1 = {
  ...
  clusters: [
    { x: 300, y: 900, amount: 2, type: "skeleton" },
    { x: 600, y: 1350, amount: 3, type: "skeleton" },
    { x: 1730, y: 2130, amount: 4, type: "skeleton" },
    { x: 1696, y: 3008, amount: 3, type: "skeleton" },
    { x: 2336, y: 704, amount: 4, type: "skeleton" },
    { x: 3616, y: 896, amount: 3, type: "skeleton" },
    { x: 5536, y: 1280, amount: 2, type: "skeleton" },
  ],
  props: [
    ...
    { x: 464 * 2, y: 1120 * 2, type: "well" },
    { x: 1647 * 2, y: 672 * 2, type: "well" },
    { x: 2672 * 2, y: 704 * 2, type: "well" },
  ],
  foilage: [
  ...
  teleporters: [{ x: 5376, y: 192, level: level1boss }],
  bounding_boxes: [
