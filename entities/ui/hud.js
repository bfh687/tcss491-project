class HUD {
  constructor(game, knight) {
    ...
    this.items = ASSET_MANAGER.getAsset(sprites.drop_items);
    this.armor = ASSET_MANAGER.getAsset(sprites.shield);
  }
  ...
  draw(ctx) {
    ...
    ctx.fillText("SP: " + this.game.knight.xp.skillPoints, 15, 45);
    ctx.restore();
    ...
    ctx.fillStyle = "black";
    ctx.fillText("L V L   " + this.knight.xp.currLevel, 27 + 20, 712 - 20 + 33, 120);
    ctx.globalAlpha = 1;
    ctx.fillStyle = "white";
    ctx.font = "14px impact";
    ctx.fillText("L V L   " + this.knight.xp.currLevel, 25 + 20, 710 - 20 + 33, 120);
    ctx.globalAlpha = 0.1;
    ctx.fillStyle = "black";
    ctx.fillText("L V L   " + this.knight.xp.currLevel, 27 + 20, 712 - 20 + 33, 120);
    ...
    ctx.fillRect(125 + 20, 720 - 16 - 20 + 33, Math.max(0, this.knight.xp.currXP / this.knight.xp.xpNeeded) * width, 4);
    ctx.restore();
