class Eyeball {
  ...
  loadAnimations() {
    ...
    this.animations[0].push(
      new Animator(this.spritesheet, 0, 0, 195, 48, 8, 0.12, 0, 0, false, true)
    );
    this.animations[0].push(
      new Animator(
        this.spritesheet,
    ...
    this.animations[1].push(
      new Animator(this.spritesheet, 0, 48, 195, 48, 8, 0.16, 0, 0, false, true)
    );
    this.animations[1].push(
      new Animator(
        this.spritesheet,
  ...
  update() {
    ...
    if (knight) {
      ...
      var knight_x =
        knight.hurtBox.left + (knight.hurtBox.right - knight.hurtBox.left) / 2;
      var knight_y =
        knight.hurtBox.top + (knight.hurtBox.bottom - knight.hurtBox.top) / 2;

      // calculate center position of eyeball
      var eyeball_x =
        this.hurtBox.left + (this.hurtBox.right - this.hurtBox.left) / 2;
      var eyeball_y =
        this.hurtBox.top + (this.hurtBox.bottom - this.hurtBox.top) / 2;
      ...
      if (dist < this.aggroDist) {
        ...
        var verticalBox = new BoundingBox(
          this.hurtBox.left,
          this.hurtBox.top + yVector * this.currSpeed * this.game.clockTick,
          20,
          23
        );
        ...
        if (
          ...
          horizontalBox.collide(knight.hurtBox) &&
          this.boundingBox.top > knight.hurtBox.top
        ) {
